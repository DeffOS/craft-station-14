...
job-description-cargotech = Обрабатывайте заказы и осуществляйте поставки в чрезвычайных ситуациях, управляйте грузовым шаттлом и работайте сообща с другими, чтобы зарабатывать смехотворные суммы денег.
...
job-description-engineer = Поддерживайте работу основного генератора и солнечных панелей станции, оптимизируйте энергосеть и проводите аварийный ремонт, используя свой космический скафандр.
...
job-description-scientist = Исследуйте инопланетные артефакты, открывайте новые технологии, улучшайте оборудование станции, и повышайте общую эффективность работы.

...
alert-level-blue-instructions = Членам экипажа рекомендуется быть бдительными и сообщать охране о подозрительной активности.
...
alert-level-violet-instructions = Членам экипажа рекомендуется отдалиться от других и принять меры безопасности для предотвращения дальнейшего распространения вируса.

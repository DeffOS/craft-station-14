...
traitor-role-uplink-code =
    Установите ноты рингтона на {$code} для блокировки или разблокировки аплинка.
    Не забудьте заблокировать его после этого, иначе экипаж станции легко откроет его тоже!
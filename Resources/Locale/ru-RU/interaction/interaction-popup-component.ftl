...
petting-success-dehydrated-carp = Вы гладите { THE($target) } по { POSS-ADJ($target) } маленькой гладкой голове. { CAPITALIZE(OBJECT($target)) } Кажется, теперь ты ему нравишься!
...
petting-failure-dehydrated-carp = Вы гладите { THE($target) } on { POSS-ADJ($target) } маленькой гладкой голове.

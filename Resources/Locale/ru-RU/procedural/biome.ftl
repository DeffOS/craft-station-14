...
cmd-biome_clear-help = biome_clear <биокомпонент>
cmd-biome_addlayer-desc = Добавляет еще один слой биома
cmd-biome_addlayer-help = biome_addlayer <mapid> <biometemplate> [seed offset]
cmd-biome_addmarkerlayer-desc = Добавляет еще один слой маркеров биома
